...
# L2 白色地块自动对正（所有像素量均按实际相机分辨率等比换算）。
AUTO_GROUND_ALIGN_TIMEOUT_MS = 20000
AUTO_GROUND_ALIGN_STABLE_OBSERVATIONS = 4
AUTO_GROUND_ALIGN_X_DEADZONE_PX_640 = 16
AUTO_GROUND_ALIGN_CENTER_Y_DEADZONE_PX_480 = 16
...
AUTO_GROUND_ALIGN_ANGLE_DEADZONE_X10 = 30
